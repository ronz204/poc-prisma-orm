-- CreateEnum
CREATE TYPE "esports"."team_member_role" AS ENUM ('SUBSTITUTE', 'CAPTAIN', 'PLAYER', 'COACH');
...
CREATE TABLE "esports"."members" (
    ...
    "role" "esports"."team_member_role" NOT NULL DEFAULT 'PLAYER',
...
-- CreateIndex
CREATE UNIQUE INDEX "members_playerId_teamId_key" ON "esports"."members"("playerId", "teamId");
